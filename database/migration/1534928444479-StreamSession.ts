...
export class StreamSession1534928444479 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "stream_session" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" integer NOT NULL DEFAULT (100), "start" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "last" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "userId" integer)`);
        await queryRunner.query(`CREATE TABLE "temporary_stream_session" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "amount" integer NOT NULL DEFAULT (100), "start" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "last" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "userId" integer, CONSTRAINT "FK_5d859efcfd20003f8d8447c875a" FOREIGN KEY ("userId") REFERENCES "user" ("id") ON DELETE CASCADE)`);
