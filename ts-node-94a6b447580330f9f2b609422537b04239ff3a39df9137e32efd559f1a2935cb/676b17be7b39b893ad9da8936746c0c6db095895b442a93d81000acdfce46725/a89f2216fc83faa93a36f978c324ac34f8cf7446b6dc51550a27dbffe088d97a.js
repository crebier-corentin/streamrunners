...
router.post('/update', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (req.isAuthenticated()) {
        ...
        let isOnline = yield StreamQueue_1.StreamQueue.isCurrentOnline(current.user.twitchId);
        //Check if stream is online
        if (!isOnline) {
            yield sendData();
            return;
