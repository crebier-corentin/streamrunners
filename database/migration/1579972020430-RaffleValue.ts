...
export class RaffleValue1579972020430 implements MigrationInterface {
    name = 'RaffleValue1579972020430'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `raffle` ADD `value` int NOT NULL DEFAULT 0", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `raffle` DROP COLUMN `value`", undefined);
    }
